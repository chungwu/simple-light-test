...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: Z4tKjcZmMzufaM/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ieLu8)}
      >
        <div className={classNames(defaultcss.all, sty.box___7SV3A)}>
          <div className={classNames(defaultcss.all, sty.box__y0W4)}>
            <p.PlasmicSlot
