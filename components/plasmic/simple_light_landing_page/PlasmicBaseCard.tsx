...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: LAUlrNa7rHZzxX/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box___2Osxu, {
          [sty.box__long___2OsxuVKtk]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__fO0Px, {
            [sty.box__long__fO0PxVKtk]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
