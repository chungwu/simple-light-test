...
import Plan from "../../Plan"; // plasmic-import: uIHObBvmrvBPTu/component
import Bullet from "../../Bullet"; // plasmic-import: xx6dCNi27Fl4My/component
import LinkButton from "../../LinkButton"; // plasmic-import: TcxeWIxGO5uhM/component
import Faq from "../../Faq"; // plasmic-import: Z4tKjcZmMzufaM/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: ZoRMPdlLILJ24J/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__kgLer)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__mLso)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__ew4Sw)}
                  >
                    <Plan
                      className={classNames("__wab_instance", sty.plan___1Rfeg)}
                      price={
                        <div
                          className={classNames(
                            defaultcss.all,
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan__yjj6C)}
                      description={
                        <p.Stack
                          as={"div"}
                          hasGap={true}
                          className={classNames(defaultcss.all, sty.box__slOtM)}
                        >
                          <Bullet
                            className={classNames(
                              "__wab_instance",
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan___7AipV)}
                      name={"Enterprise"}
                      price={
                        <div
                          className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__aEw6F)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__mmisg)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__qyluT)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__dlJpu)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
