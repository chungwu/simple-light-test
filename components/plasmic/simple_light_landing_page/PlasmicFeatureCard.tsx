...
import * as sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: et5mJdq774ini/css
  ...
  return (
    ...
    >
      {(hasVariant(variants, "long", "long") ? false : true) ? (
        <div
          className={classNames(defaultcss.all, sty.box__cLhLp, {
            [sty.box__long__cLhLp8GGsx]: hasVariant(variants, "long", "long")
          })}
        >
          <div
            className={classNames(defaultcss.all, sty.box__v5KlM, {
              [sty.box__long__v5KlM8GGsx]: hasVariant(variants, "long", "long")
            })}
          >
            <p.PlasmicSlot
              defaultContents={
                <svg
                  className={classNames(defaultcss.all, sty.svg__t5Pei)}
                  role={"img"}
                />
              }
      ...
      <div
        className={classNames(defaultcss.all, sty.box__rgNw8, {
          [sty.box__long__rgNw88GGsx]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__nXhqz, {
            [sty.box__long__nXhqz8GGsx]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__cIeMy)}
                role={"img"}
              />
            }
            value={args.iconBack}
