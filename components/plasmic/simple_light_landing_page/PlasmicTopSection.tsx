...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: 2kciu-7Ojyqtb/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ylhmX)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___1I3Ry)}
        >
          <div className={classNames(defaultcss.all, sty.box__ser4E)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__p2Kq2)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__w8Xpv)}
            text={"Start free trial"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton___9OjEp)}
            text={"Learn more"}
            type={"solidBlack" as const}
          />
        </p.Stack>

        <div className={classNames(defaultcss.all, sty.box__nadBo)}>
          <img
